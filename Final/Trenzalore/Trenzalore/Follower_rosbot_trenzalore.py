...
class DistanceReceiver(Node):
    ...
    def odom_callback(self, msg):
        ...
        self.get_logger().info(f"Current Position: x: {position.x}, y: {position.y}, z: {position.z}")
        ...
        angle_to_point, direction = self.calculate_angle_and_direction(position, yaw, self.last_known_pos)
